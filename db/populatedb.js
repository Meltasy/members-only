...
const userList = [
  ...
  { username: 'mr.white@tarantino.org', password: 'WhiteISBlack*8*', firstName: 'Mister', lastName: 'White', member: true, admin: false, title: 'Don\'t move!', message: 'You don\'t know me and I don\'t know you.' },
  ...
  { username: 'andy.dufresne@outlook.com', password: 'HopeIS****1966', firstName: 'Andy', lastName: 'Dufresne', member: true, admin: false, title: 'Let me go!', message: 'Some birds weren\'t meant to be caged!' }
]
